    ...
    return (
        <div className="">
            ...
            <div className="h-[100vh] w-full flex flex-col justify-center text-center bg-cover bg-[#A51D21] overflow-hidden " style={{ backgroundImage: `url(${back})`, backgroundPosition: 'center center' }}>
                <div className=" bg-[#003748] absolute w-full h-[100vh] opacity-30 z-10 "></div>
                <img
                    src={deer}
                    className='xl:w-[20rem] w-[15rem] m-auto absolute left-1/2 top-[38%] xl:top-[31%]  transform -translate-x-1/2 -translate-y-1/2 z-20'
                    alt=""
                />
                ...
                <div className="flex justify-center items-center w-10 rounded-[30px] h-10 bg-white fixed bottom-[1.75rem] right-3 shadow-xl  xl:w-[3.5rem] xl:h-[3.5rem]  xl:bottom-[1.75rem] z-20 ">
                    <a href="https://wa.me/+212619861440" target="_blank" rel="noopener noreferrer">
