...
const Footer = () => {
    return (
        <div className=" flex items-center flex-col  p-5">
            ...
            <p className='font-poppins text-[14px] text-[#003748] mt-3 ' >We are Perfectionists, obsessed with perfection.</p>
            ...
            <ul class="wrapper">
                <a href="https://web.facebook.com/profile.php?id=100088203763826&mibextid=ZbWKwL&_rdc=1&_rdr" >
                ...
                <a href="https://www.instagram.com/agencyayl/" >
