            ...
            <div className=" mt-3 mb-14 w-full flex flex-col ">
                <div className=" w-full flex h-fit  justify-between ">
                    <div className="xl:w-[500px] w-[48%]  h-fit box " >
                        <div className="xl:h-[300px] h-[150px] flex flex-col items-start p-5 ">
                            ...
                            <p className='font-poppins xl:xl:text-[12px] text-[5px] text-right opacity-25  cursor-pointer ' onClick={() => { handelclickonsavoirplu(1) }}  >En savoir plus </p>
                        </div>
                    </div>
                    <div className="xl:w-[500px] xl:h-[300px] w-[48%] h-[150px]    box flex flex-col items-start p-5 ">
                        ...
                        <p className='font-poppins xl:text-[12px] text-[5px] text-right opacity-25  cursor-pointer ' onClick={() => { handelclickonsavoirplu(2) }} >En savoir plus </p>
                    </div>
                </div>
                <div className=" w-full flex h-fit  justify-between mt-7 ">
                    <div className="xl:w-[500px] xl:h-[300px] w-[48%] h-[150px]    box flex flex-col items-start p-5 ">
                        ...
                        <p className='font-poppins xl:text-[12px] text-[5px] text-right opacity-25 cursor-pointer ' onClick={() => { handelclickonsavoirplu(3) }} >En savoir plus </p>
                    </div>
                    <div className="xl:w-[500px] xl:h-[300px] w-[48%] h-[150px]    box flex flex-col items-start p-5 ">
                        ...
                        <p className='font-poppins xl:text-[12px] text-[5px] text-right opacity-25 cursor-pointer ' onClick={() => { handelclickonsavoirplu(4) }} >En savoir plus </p>
                    </div>
                </div>
            </div>
        </div>
