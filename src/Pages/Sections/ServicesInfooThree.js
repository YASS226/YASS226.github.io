            ...
            <div className="">
                ...
                <div className=" w-[80%] m-auto flex xl:flex-row flex-col-reverse items-center pt-10 ">
                    <div className="flex flex-col  items-start ">
                        <div className=" mt-[6%] ">
                            <div className=" ">
                                <img className=" xl:w-[87.67px] xl:h-[87.67px] w-[35px] h-[35px] opacity-75 mb-3 mt-[80px]" src={mark} alt="" />
                ...
                <div className="xl:w-[60%] w-[80%] m-auto xl:mt-[5%] mt-[10%] flex justify-around ">
                    <div className="xl:w-[270px] xl:h-[200px] w-[30%] h-[80px] shadow-md flex flex-col items-start xl:p-5 p-3 z-20 cursor-pointer " onClick={() => { handelclickonsavoirplu(2) }} >
